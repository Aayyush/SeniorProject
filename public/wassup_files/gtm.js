...
var Ld=[C.B,C.J],Md=function(a){var b=a[C.Qd];b&&D(40);var c=a[C.Rd];c&&D(41);for(var d=Fa(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==C.Qd&&f!==C.Rd)if(-1<Ga(Ld,f)){var h=f,k=a[f],l=d[e];wd().set(h,k,l,"US","US-DC",c)}else{}},Nd=function(a,b){for(var c in a)if(a.hasOwnProperty(c))if(-1<
...
B){v&&"id"===A?y.Ta.promotion_id=B:v&&"name"===A?y.Ta.promotion_name=B:y.Ta[A]=B}}(x)),l.items.push(x.Ta)}if(t)for(var w in t)h.hasOwnProperty(w)?n(h[w],t[w]):n(w,t[w])},p;if("dataLayer"===d.vtp_getEcommerceDataFrom){p=p||gf(d.vtp_gtmEventId,"eventModel");if(!p){p=p||gf(d.vtp_gtmEventId,"ecommerce")}}else p=d.vtp_ecommerceMacroData;if(qb(p)){c.push(5);for(var r in p)p.hasOwnProperty(r)&&("currencyCode"===r?n("currency",p.currencyCode):"impressions"===r&&e===C.Vb?q(p.impressions,null):"promoClick"===r&&e===C.Yd?q(p.promoClick.promotions,p.promoClick.actionField,!0):"promoView"===r&&e===C.Zd?q(p.promoView.promotions,p.promoView.actionField,!0):k.hasOwnProperty(r)?e===
k[r]&&q(p[r].products,p[r].actionField):l[r]=p[r]);m(l,f)}}var c=[];(function(d){Z.__gaawe=d;Z.__gaawe.h="gaawe";Z.__gaawe.i=!0;Z.__gaawe.priorityOverride=0})(function(d){var e=String(d.vtp_measurementIdOverride||d.vtp_measurementId),f=String(d.vtp_eventName);if("_"===f.charAt(0))J(d.vtp_gtmOnFailure);else{var h={};c=[];d.vtp_sendEcommerceData&&(0<=C.Ce.indexOf(f)||"checkout_option"===f)&&b(d,f,h);var k=co(d.vtp_eventParameters,"name","value"),l;for(l in k)k.hasOwnProperty(l)&&(h[l]=k[l]);if(h.hasOwnProperty(C.sa)||
d.vtp_userProperties){var n=h[C.sa]||{};m(co(d.vtp_userProperties,"name","value"),n);h[C.sa]=n}Cq(h);0<c.length&&(h[C.dd]=c);a(h,C.Be,function(q){return Qa(q)});a(h,C.De,function(q){return Number(q)});Cl(f,h,e);J(d.vtp_gtmOnSuccess)}})}();
...
0})(function(f){var h=W("self");if(!tn("hl")){var k=e();b(h,k);c(h,k);d("pushState",h,k);d("replaceState",h,k);un("hl")}J(f.vtp_gtmOnSuccess)})}();
